...
function dataviz() {
    ...
    central_group
        ...
        .style("text-align", "center")
        .style("fill", "grey")
        .text("(1) 1930, 1950–1970 and 1986–2018: group stage | 1934–1938: knockout round of 16 | 1974–1982: first group stage. ");
    ...
    main_group.append("circle").attr("r", 2).attr("cx", -30).attr("cy", 55).style("fill", "grey").style("fill-opacity", 1);
