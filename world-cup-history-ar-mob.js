...
dimensions_hist_m_ar.vizboardWidth = dimensions_hist_m_ar.width - dimensions_hist_m_ar.margin.left - dimensions_hist_m_ar.margin.right;

dimensions_hist_m_ar.vizboardHeight = dimensions_hist_m_ar.height - dimensions_hist_m_ar.margin.top - dimensions_hist_m_ar.margin.bottom;

///////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// Draw SVG
const vizboardWidth_hist_m_ar = 450;
const vizboardHeight_hist_m_ar = 800;

const vizboard_hist_m_ar = d3
    .select("#vizboard-hist-m-ar")
    .append("svg")
    .classed("svg-vizboard", true)
    .attr("viewBox", `0 0 ${vizboardWidth_hist_m_ar} ${vizboardHeight_hist_m_ar}`)
    .attr("preserveAspectRatio", "xMinYMin meet");
// .style("border", "1px dashed red");

let svg_hist_m_ar = vizboard_hist_m_ar
    .append("g")
    .style("transform", `translate(${dimensions_hist_m_ar.margin.left}px, ${dimensions_hist_m_ar.margin.top}px)`);

///////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// Create SVG dimensions
let width_hist_m_ar = vizboardWidth_hist_m_ar - dimensions_hist_m_ar.margin.left - dimensions_hist_m_ar.margin.right;
let height_hist_m_ar = vizboardHeight_hist_m_ar - dimensions_hist_m_ar.margin.top - dimensions_hist_m_ar.margin.bottom;
...
function dataviz_hist_m_ar() {
    ...
    const wc_years_scale = d3
        ...
        .range([width_hist_m_ar - 20, 0 + 10]);

    const wc_stages_scale = d3
        .scalePoint()
        .domain(["R1", "R2", "QF", "4th", "3rd", "2nd", "1st"])
        .range([0 + 150, height_hist_m_ar - 250]);

    const wc_labels_scale = d3
        .scalePoint()
        .domain(["الدور الأول", "الدور الثاني", "ربع النهائي", "المركز الرابع", "المركز الثالث", "المركز الثاني", "الفائز"])
        .range([0 + 170, height_hist_m_ar - 230]);

    const wc_h_scale = d3.scaleLinear().domain([1, 8]).range([width_hist_m_ar, -90]);
    ...
    var svgDefs = svg_hist_m_ar.append("defs");
    // 1
    ...
    ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    const central_group = svg_hist_m_ar.append("g").classed("central-group", true).attr("transform", `translate(0,0)`);
    ...
    central_group
        ...
        .attr("y", 60)
        .attr("height", 530)
        .attr("width", width_hist_m_ar + 260)
        .style("fill", "none")
    ...
    const stage_labels = central_group
        ...
        .data(["الدور الأول", "الدور الثاني", "ربع النهائي", "المركز الرابع", "المركز الثالث", "المركز الثاني", "الفائز"])
        .join("text")
        .attr("class", "stage-label")
        .attr("x", width_hist_m_ar + 50)
    ...
    central_group
        .append("line")
        .attr("x1", width_hist_m_ar + 38)
        .attr("y1", 150)
        .attr("x2", width_hist_m_ar + 38)
        .attr("y2", 510)
        .style("stroke", "grey")
        .style("stroke-width", 1)
        .style("stroke-opacity", 0.3);
    ...
    d3.selectAll("#id-appearances").text(worldcup_history_data.filter((d) => d.team_txt == "Brazil").length);
    ...
    let m_team = document.getElementById("team-d");
    let mtext, mvalue;
    ...
    for (i = 0; i < l; i++) {
        ...
        a.addEventListener("click", function (e) {
            ...
            mtext = m_team.options[m_team.selectedIndex].text;
            mvalue = m_team.options[m_team.selectedIndex].value;
            //log value
